        ...
        <div className="mx-auto flex max-w-5xl flex-col items-center">
          <div className="z-10 flex flex-col items-center gap-6 text-center">
            ...
            <Badge
              ...
              className=""
              style={{
                background: "linear-gradient(360, #5391c1, #876bca)",
            ...
            <div>
              ...
              <p className="lg:text-xl text-black/75 mt-2">
                I Don't Know AI est une IA qui permet à l'utilisateur de faire
                part de sa santé mentale et de maintenir un état de santé sain.
                En gros, c'est comme un médecin, mais sans le stéthoscope !
              </p>
            </div>
            <button
              className="px-8 py-3 m-5 text-xl text-white bg-[#fef7f9] rounded-lg"
              onClick={handleLogin}>
              Get Started
            </button>
          </div>
