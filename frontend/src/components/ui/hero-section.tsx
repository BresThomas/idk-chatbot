      ...
      <div className='container'>
        ...
        <div className='mx-auto flex max-w-5xl flex-col items-center'>
          <div className='z-10 flex flex-col items-center gap-6 text-center'>
            ...
            />
            <Badge variant='outline'>I Don't Know AI</Badge>
            <div>
              ...
              <p className='text-muted-foreground lg:text-xl'>
                ...
                part de sa santé mentale et permet à l'utilisateur de maintenir
                un état de santé saint.
              </p>
            </div>
            <button
              className='px-8 py-3 m-5 text-xl text-white bg-[#709CA7] rounded-lg'
              onClick={handleLogin}
            >
              Get Started
            </button>
